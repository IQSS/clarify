...
Several packages offer methods for computing interpretable quantities form regression models, including \CRANpkg{emmeans} [@emmeans2024], \CRANpkg{margins} [@margins2021], \CRANpkg{modelbased} [@modelbased2020], and \CRANpkg{marginaleffects} [@marginaleffectsforthcoming]. Many of the quantities computed by these packages can also be computed by \CRANpkg{clarify}, the primary difference being that \CRANpkg{clarify} uses simulation-based inference rather than delta method-based inference.
