...
## ----plot1, fig.width=4, fig.alt="A plot of the density of the simulated predicted probability for participant PSID1, overlaid with a Normal distribution and a reference line for the median of the estimates"----
...
## ----plot2, fig.width=4, fig.alt = "A plot of the density of the simulated difference between two regression coefficients, overlaid with a Normal distribution and a reference line for the median of the estimates."----
...
## ----plot3, fig.width=5, fig.alt = "Two plots of the densities of the simulated predictions of the outcome for control and treated units, one corresponding to re74 = 0 and the other to re75 = 20000."----
...
## ----plot4, fig.width=5, fig.alt = "A plot of the predicted values of the outcome across levels of re75 from 0 to 20000 with a line for control units and a line for treated units. Each line has an uncertainty band around it."----
plot(est4)
...
## ----plot8, fig.width=5, fig.alt = "A plot of the average dose-response function for the outcome against age. The line has an uncertainty band around it."----
plot(est8)
...
## ----plot9, fig.width=5, fig.alt = "A plot of the average marginal effect function for the outcome against age. The line has an uncertainty band around it."----
plot(est9)
