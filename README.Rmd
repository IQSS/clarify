...
`clarify` implements simulation-based inference as an alternative to the delta method for computing functions of model parameters, such as average marginal effects. See the `clarify` [website](https://iqss.github.io/clarify) for documentation and other examples.
