...
Several packages offer methods for computing interpretable quantities form regression models, including \CRANpkg{emmeans} [@lenthEmmeansEstimatedMarginal2024], \CRANpkg{margins} [@leeperMarginsMarginalEffects2024], \CRANpkg{modelbased} [@makowskiEstimationModelbasedPredictions2020], and \CRANpkg{marginaleffects} [@arel-bundockMarginaleffectsPredictionsComparisons2024]. Many of the quantities computed by these packages can also be computed by \CRANpkg{clarify}, the primary difference being that \CRANpkg{clarify} uses simulation-based inference rather than delta method-based inference.
